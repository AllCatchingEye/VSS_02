...
type RetoureRequest struct {
	...
	Products   map[uint32]uint32 `protobuf:"bytes,4,rep,name=products,proto3" json:"products,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *RetoureRequest) GetProducts() map[uint32]uint32 {
	if x != nil {
		return x.Products
	}
	return nil
...
var file_microservices_api_shipmentApi_shipmentApi_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x64, 0x22, 0xee, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x74, 0x6f, 0x75, 0x72, 0x65, 0x52,
	...
	0x12, 0x45, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x29, 0x2e, 0x73, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x70, 0x69,
	0x2e, 0x52, 0x65, 0x74, 0x6f, 0x75, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x28, 0x0a, 0x0c, 0x52, 0x65, 0x74, 0x6f, 0x75, 0x72, 0x65, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x42, 0x57,
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x68, 0x69, 0x70,
	0x6d, 0x65, 0x6e, 0x74, 0x41, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_microservices_api_shipmentApi_shipmentApi_proto_goTypes = []interface{}{
	...
	nil,                           // 6: shipmentApi.RetoureRequest.ProductsEntry
	(*types.Address)(nil),         // 7: types.Address
}
var file_microservices_api_shipmentApi_shipmentApi_proto_depIdxs = []int32{
	7, // 0: shipmentApi.ShipMyOrderReply.address:type_name -> types.Address
	6, // 1: shipmentApi.RetoureRequest.products:type_name -> shipmentApi.RetoureRequest.ProductsEntry
