...
var file_microservices_api_stockApi_stockApi_proto_rawDesc = []byte{
	...
	0x75, 0x63, 0x74, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x42, 0x54, 0x5a, 0x52,
...
var file_microservices_api_stockApi_stockApi_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_microservices_api_stockApi_stockApi_proto_goTypes = []interface{}{
	...
	(*types.Product)(nil),        // 6: types.Product
}
var file_microservices_api_stockApi_stockApi_proto_depIdxs = []int32{
	6, // 0: stockApi.AddProductsRequest.products:type_name -> types.Product
	6, // 1: stockApi.GetProductsReply.products:type_name -> types.Product
	6, // 2: stockApi.RemoveProductReply.product:type_name -> types.Product
