...
type CustomerServiceClient interface {
	...
	RemoveCustomer(ctx context.Context, in *RemoveCustomerRequest, opts ...grpc.CallOption) (*RemoveCustomerReply, error)
}
...
func (c *customerServiceClient) AddCustomer(ctx context.Context, in *AddCustomerRequest, opts ...grpc.CallOption) (*AddCustomerReply, error) {
	out := new(AddCustomerReply)
	err := c.cc.Invoke(ctx, "/customerApi.CustomerService/AddCustomer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerServiceClient) GetCustomer(ctx context.Context, in *GetCustomerRequest, opts ...grpc.CallOption) (*GetCustomerReply, error) {
	...
	err := c.cc.Invoke(ctx, "/customerApi.CustomerService/GetCustomer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerServiceClient) RemoveCustomer(ctx context.Context, in *RemoveCustomerRequest, opts ...grpc.CallOption) (*RemoveCustomerReply, error) {
	out := new(RemoveCustomerReply)
	err := c.cc.Invoke(ctx, "/customerApi.CustomerService/RemoveCustomer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServiceServer interface {
	...
	RemoveCustomer(context.Context, *RemoveCustomerRequest) (*RemoveCustomerReply, error)
...
func (UnimplementedCustomerServiceServer) AddCustomer(context.Context, *AddCustomerRequest) (*AddCustomerReply, error) {
...
func (UnimplementedCustomerServiceServer) RemoveCustomer(context.Context, *RemoveCustomerRequest) (*RemoveCustomerReply, error) {
...
func _CustomerService_AddCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/customerApi.CustomerService/AddCustomer",
	}
...
func _CustomerService_GetCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/customerApi.CustomerService/GetCustomer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CustomerService_RemoveCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/customerApi.CustomerService/RemoveCustomer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CustomerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "customerApi.CustomerService",
